...
namespace render
{
	...
	public:
		...
		void FillWriteDescriptorSet(VkWriteDescriptorSet& write_desc_set)
		{
			vk_image_info_.imageLayout = (image_view_.GetImageType() == ImageType::kDepthMapImage || image_view_.GetImageType() == ImageType::kGDepthImage) ? VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL : VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL;
