...
namespace render
{
	...
	using SceneDescriptorSetHolder = descriptor_sets_holder::Holder<DescriptorSetType::kCameraPositionAndViewProjMat, DescriptorSetType::kCubeMap, DescriptorSetType::kEnvironement>;
	...
	public:
		...
		bool FillData(render::DescriptorSet<render::DescriptorSetType::kCubeMap>::Binding<0>::Data& data) override;
